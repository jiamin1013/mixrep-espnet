# to visualize offsets
python plot_offset.py --model exp/train_nodup_sp_pytorch_conformer_deform_run0/results/model.last10.avg.best --recog-json dump/eval2000/deltafalse/data_bpe2000.json --result-label a.lbl
